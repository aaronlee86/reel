...
"$VENV_PYTHON" "$PYTHON_SCRIPT" --part=1 --level=1 --count=10 --db="$DB_PATH" --img
"$VENV_PYTHON" "$PYTHON_SCRIPT" --part=1 --level=2 --count=10 --db="$DB_PATH" --img
"$VENV_PYTHON" "$PYTHON_SCRIPT" --part=1 --level=3 --count=10 --db="$DB_PATH" --img
"$VENV_PYTHON" "$PYTHON_SCRIPT" --part=2 --level=1 --count=10 --db="$DB_PATH"
"$VENV_PYTHON" "$PYTHON_SCRIPT" --part=2 --level=2 --count=10 --db="$DB_PATH"
"$VENV_PYTHON" "$PYTHON_SCRIPT" --part=2 --level=3 --count=10 --db="$DB_PATH"
